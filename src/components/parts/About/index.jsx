...
export default function About() {
  return (
    <section className="container min-height-screen center-flex" id="about-section">
      <div className="image">
      ...
      <div className="content">
        ...
        <div className="mt-5 paragraph">
          <p>
            ...
            Veteran Jakarta campus.
          </p>
          <br />
          <p>
            I am interested in learning about Web Development, UI/UX Design, and Backend Development. I have experience
            in making several products for campus assignments and client requests. Building a project gave me a lot of
            experience and training to solve a problem.
          </p>
          <br />
          <p>
